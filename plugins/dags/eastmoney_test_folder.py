...
from operators.eastmoney_operator_folder import EastmoneyOperator_folder
...
with DAG(
    ...
    east_money_tc = EastmoneyOperator_folder(
        task_id='east_money_operator_folder',
